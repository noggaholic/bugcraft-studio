...
export const alpha = {
  ...
  cameraViewMatrix: {
    version: {
      ['0.5.3']: [
        {
          pattern: new Buffer([0xD8, 0x86, 0xE4, 0x00, 0x00, 0x00, 0xD9, 0x9E, 0xD8, 0x00, 0x00, 0x00]),
          fix:     new Buffer([0xD8, 0x86, 0xE4, 0x00, 0x00, 0x00, 0xD9, 0x9E, 0xD0, 0x00, 0x00, 0x00])
        },
        {
          pattern: new Buffer([0x89, 0x9E, 0x64, 0x01, 0x00, 0x00, 0x89, 0x8E, 0xDC, 0x00, 0x00, 0x00]),
          fix:     new Buffer([0x89, 0x9E, 0x64, 0x01, 0x00, 0x00, 0x89, 0x8E, 0xD0, 0x00, 0x00, 0x00])
        }
      ],
      ['0.8.0']: {
