...
.content h1, .content h2, .content h3, .content h4, .content h5, .content h6, .content p, .title, .subtitle {
    color: #e8e8e8;
}
...
.nav-item a:not(.button).is-tab.is-active, a.nav-item:not(.button).is-tab.is-active {
    border-bottom: 1px solid #f5fe6f;
    color: #f5fe6f;
}
...
.input, .input:hover, .input.is-hovered, .textarea:hover, .textarea.is-hovered,
...
.modal-background.loading {
  background-image: url(assets/resources/images/cover.png);
...
.modal-content.loading-text{
  color: #e0e0e0;
  text-shadow: 2px 2px 8px rgb(133, 154, 255);
  font-size: 2em;
}
</style>
